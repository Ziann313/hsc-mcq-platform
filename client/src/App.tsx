...
function RouteLoader() { return <div className="grid min-h-screen place-items-center bg-[#f4f7f7] px-5 text-center" role="status" aria-live="polite" aria-label="Loading MCQ GURU"><div className="mcq-route-loader"><div className="mcq-route-loader__orbit"><span className="mcq-route-loader__ring mcq-route-loader__ring--one" /><span className="mcq-route-loader__ring mcq-route-loader__ring--two" /><span className="mcq-route-loader__spark mcq-route-loader__spark--one" /><span className="mcq-route-loader__spark mcq-route-loader__spark--two" /><span className="mcq-route-loader__book"><span /><span /><span /></span></div><p className="mt-6 font-display text-xl font-extrabold text-[#071d33]">MCQ GURU</p><p className="mt-1 text-sm font-semibold text-[#087b6c]">Finding your next learning signal…</p><div className="mcq-route-loader__progress mt-4"><span /></div></div></div>; }
